...
from uk_housing_ml.audit.readiness import run_readiness_audit
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        / "config"
        / "readiness_audit.yml",
        help="Path to the readiness audit YAML configuration.",
    )
...
def main() -> int:
    ...
    print(
        f"Datasets discovered: {summary['dataset_count']}"
    )
    print(
    ...
    print(
        f"Failed profiles: {summary['failed_dataset_count']}"
    )
    print(
        "Temporal datasets: "
