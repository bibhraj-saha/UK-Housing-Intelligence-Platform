...
st.subheader(
    ...
    "Machine Learning Investment Intelligence"
...
investment opportunity predictions
directly from the
...
Machine Learning investment opportunity insights.
"""
)
...
with st.spinner(
    ...
    "Retrieving investment intelligence..."
...
st.success(
    f"""
Investment intelligence successfully retrieved for
...
These investment metrics are generated by the
Phase 10 Machine Learning Serving Layer and
delivered through the Phase 11 FastAPI REST API.
"""
)
...
summary = {
    ...
    "Investment Probability": formatted_probability,
